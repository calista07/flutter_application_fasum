...
class AddPostScreen extends StatefulWidget {
  ...
  @override
  State<AddPostScreen> createState() => _AddPostScrRFeenState();
}

class _AddPostScrRFeenState extends State<AddPostScreen> {
  File? _image;
  XFile? _pickedFile;
  ...
  final String _apiKey = 'AQ.Ab8RN6IHP-NjULFQuiz3aslCp4wDGfVP8KYF9YAk4-8frcWD8Q';
